				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						if cmd == "logout":
                            ...
                            img = client.downloadFileWithURL("https://pm1.narvii.com/6819/da4fc867cdd3c534f1f4a8f55b3fe722ad78186bv2_hq.jpg")
                            vid = client.downloadFileWithURL("http://78.47.157.189/ig/l13/yKaz194V-CuDlVmJ1Q8IzQ,1540220515/yt:bT2AMc8hI6A-8/Weki%20Meki%20%EC%9C%84%ED%82%A4%EB%AF%B8%ED%82%A4%20-%20Crush%20MV.mp4")
                            client.changeVideoAndPictureProfile(img, vid)
						elif cmd == "me":
							client.sendMention(to, "@!", [sender])
							client.sendContact(to, sender)
							client.sendMessageMusic(to)
						elif cmd == "myprofile":
							contact = client.getContact(sender)
