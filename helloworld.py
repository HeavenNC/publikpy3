...
#client = LINE()
client = LINE("EyEwqS8OOylh1guTq0S7.NJBaaPWX4ChwW2QkFbp+nW.02bZuQYO+g6eh7633w0E9dsbLrVRfj2ultQr0AfxaLk=")
...
def helpmessage():
    ...
    helpMessage =   "╔══════════════" + "\n" + \
                    ...
                    "║✪╠➤▸› [ Self Command ]" + "\n" + \
                    "╔═╝" + "\n" + \
                    "╠ " + key + "ChangeName:「Subject」" + "\n" + \
                    "╠ " + key + "ChangeBio:「Subject」" + "\n" + \
                    "╠ " + key + "Me" + "\n" + \
                    "╠ " + key + "MyMid" + "\n" + \
                    "╠ " + key + "MyName" + "\n" + \
                    "╠ " + key + "MyBio" + "\n" + \
...
def helptexttospeech():
    ...
    helpTextToSpeech =  "╔══════════════" + "\n" + \
                        ...
                        "╠ " + key + "vi : Vietnamese" + "\n" + \
                        "╠ " + key + "cy : Welsh" + "\n" + \
                        "╠➤ [ Contoh : " + key + "say-id Irene / Monika ]" + "\n" + \
                        "╠══════════════" + "\n" + \
                        "║               By : Irene / Monika 􀄃􀆖cony kiss􏿿" + "\n" + \
                        "║          line.me/ti/p/~syifaabyananta" + "\n" + \
                        "╚══════════════"
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if cmd == "help":
                                ...
                                client.sendMessage(to, str(helpMessage), contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+client.getContact(clientMid).pictureStatus, 'AGENT_NAME': 'Irene', 'AGENT_LINK': 'https://line.me/ti/p/~syifaabyananta'})
                            elif cmd == "tts":
                                ...
                                client.sendMessage(to, "[ Speed ]\nKecepatan mengirim pesan {} detik".format(str(elapsed_time)))
                                 ...
                                 client.sendMessage(to, "[ Running Time ]\n Durasi: {}".format(str(runtime)), contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+client.getContact(clientMid).pictureStatus, 'AGENT_NAME': 'Irene', 'AGENT_LINK': 'https://line/ti/p/~syifaabyananta'})                                                  
                            elif cmd == "restart":
...
# Pembatas Script #
                                ...
                                client.sendMessage(to, 'Owner : \nIg : https://www.instagram.com/syifaabyananta',contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+client.getContact(clientMid).pictureStatus, 'AGENT_NAME': 'Irene', 'AGENT_LINK': 'https://line/ti/p/~syifaabyananta'})
                            elif cmd == "mymid":
...
# Pembatas Script #
                            	...
                            	if msg.contentType == 0:
                                    ...
                                    if msg.contentType == 2:
                                        ...
                                        if msg.contentType == 1:
                                            ...
                                            client.sendMessage(to, "Success, thanks to Irene")
                            	...
                            	picture = client.downloadFileURL("https://pm1.narvii.com/6819/da4fc867cdd3c534f1f4a8f55b3fe722ad78186bv2_hq.jpg", saveAs="image.jpg")
                            	video = client.downloadFileURL("https://www.s11.saveoffline.com/get/?i=Q34nda9JsFHvgvqjkp0HZriE1Fdq5BRG&u=rdZnkYS0c5IjFferMyOJmk0iUe8KiXyk", saveAs="video.mp4")
