				...
				if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
					...
					if msg.contentType == 0:
						if cmd == "logout":
							...
							client.sendMessage(to, "Irene BOT telah aktif selama {}".format(str(runtime)))
							...
							client.sendReplyMessage(msg_id, to, helpMessage3)
						elif cmd == "settings":
							if msg._from in admin:
							...
							client.sendMessageMusic(to, "{}".format(contact.displayName), "{}".format(contact.statusMessage), "line.me/ti/p/~syifaabyananta", "{}".format(contact.pictureStatus))
						elif cmd == "myprofile":
							contact = client.getContact(sender)
						...
						if settings["checkPost"] == True:
							try:
								...
								client.createComment(url[25:58], url[66:], setting["message"])
								client.sendMessage(to, "Like Succes")
							except:
